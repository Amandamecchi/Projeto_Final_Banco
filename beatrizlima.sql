...
(10, 'Interruptor molecular sintético permite “pintar” com luz natural; entenda', 
 'Novo estudo relata cristais líquidos imprimíveis com aplicações que vão desde telas de eficiência energética até marcas d''água de alta tecnologia', 
 'Outras aplicações para cristais líquidos podem um dia ser possíveis, alimentadas por luz natural, segundo sugere um novo estudo da revista Nature Chemistry, realizado por pesquisadores da Faculdade de Dartmouth e da Southern Methodist University. Essas utilizações permitem incluir lasers de cristal líquido, telas de exibição que podem ser facilmente impressas e apagadas, e etiquetas microscópicas que podem ser adicionadas a notas bancárias para deter falsificadores. Os cristais líquidos existem em fase própria e podem fluir como líquidos, mas como suas moléculas são organizadas de uma forma um tanto ordenada, elas podem ser facilmente manipuladas para refletir a luz. Essa flexibilidade fez dos cristais líquidos o material de referência para telas de telefones, TVs e computadores com eficiência energética. A pesquisa ainda cita que no coração desses gadgets está um interruptor molecular sintético que pode desencadear mudanças de forma em cristais líquidos que permitem que eles reflitam cores diferentes. Projetado no laboratório de Ivan Aprahamian, um professor de química de Dartmouth, o interruptor é feito da molécula orgânica triptycene e uma classe de compostos chamados hidrazonas que podem ligar e desligar com um pulso de luz — um feixe de luz intenso e fino que se forma quando a energia se concentra no tempo. No estudo, Aprahamian e seus colegas mostram que as hidrazonas podem ser anexadas ao triptycene de tal forma que a simetria da molécula se quebra, tornando-a quiral. Moléculas quirais vêm em duas formas de imagem espelhada que, como nossas mãos, não podem ser completamente sobrepostas uma à outra. Quando o triptycene quiral interage com uma molécula de cristal líquido, ele desencadeia uma cadeia de eventos que faz com que outras moléculas de cristal líquido se alinhem, reorganizando-se em hélices retorcidas, semelhantes ao DNA. “Ao aumentar ou diminuir o tom da estrutura helicoidal, podemos controlar a cor que ela reflete”, diz Aprahamian. O estudo fornece reproduções vívidas de “O Grito”, de Edvard Munch, e “A Noite Estrelada”, de Van Gogh, como prova. Veja um exemplo acima. Em um processo que lembra a serigrafia multicolorida, os pesquisadores usaram o pequeno projetor para projetar luz por meio de uma série de estênceis em uma tela improvisada feita de cristais líquidos dopados com triptycene quiral. Novas cores foram adicionadas, uma por uma, ao brilhar a luz por vários períodos na parte da tela deixada exposta pelo estêncil. O laboratório de Aprahamian já projetou interruptores de hidrazona antes, mas esta versão é a primeira a provar ser capaz de refletir a cor visível de um cristal líquido. O estudo descreve em detalhes o que acontece no nível molecular, o que pode ajudar os pesquisadores a investigar melhor os cristais líquidos para novas aplicações.', 
 'Artes', 
 '2024-10-17', 
 'https://www.cnnbrasil.com.br/wp-content/uploads/sites/12/2024/10/o-grito-interruptor-molecular.jpg?w=700');
